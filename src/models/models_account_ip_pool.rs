...
pub struct ModelsAccountIpPool {
...
impl ModelsAccountIpPool {
  pub fn new() -> ModelsAccountIpPool {
    ModelsAccountIpPool {
      created: None,
      id: None,
      ips: None,
  ...
  pub fn with_created(mut self, created: i64) -> ModelsAccountIpPool {
    self.created = Some(created);
    self
  }
  ...
  pub fn with_id(mut self, id: i64) -> ModelsAccountIpPool {
    self.id = Some(id);
    self
  }
  ...
  pub fn with_ips(mut self, ips: Vec<::models::ModelsIp>) -> ModelsAccountIpPool {
    self.ips = Some(ips);
    self
  }
  ...
  pub fn with_name(mut self, name: String) -> ModelsAccountIpPool {
    self.name = Some(name);
    self
  }
  ...
  pub fn with_routing_meta_data(mut self, routing_meta_data: String) -> ModelsAccountIpPool {
    self.routing_meta_data = Some(routing_meta_data);
    self
  }
  ...
  pub fn with_routing_strategy(mut self, routing_strategy: i64) -> ModelsAccountIpPool {
    self.routing_strategy = Some(routing_strategy);
    self
  }
  ...
  pub fn with__type(mut self, _type: ::models::ModelsIpPoolType) -> ModelsAccountIpPool {
    self._type = Some(_type);
    self
  }
