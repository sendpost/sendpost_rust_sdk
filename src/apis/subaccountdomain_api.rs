...
pub trait SubaccountdomainApi {
    ...
    fn domain_router_verify_by_token(&self, x_sub_account_api_key: &str, domain_id: i64, token: &str) -> Box<Future<Item = ::models::ModelsDomain, Error = Error<serde_json::Value>>>;
    fn domain_router_verify_request(&self, x_sub_account_api_key: &str, domain_id: i64, body: ::models::ModelsVerifyByTokenRequest) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>SubaccountdomainApi for SubaccountdomainApiClient<C> {
    ...
    fn domain_router_verify_by_token(&self, x_sub_account_api_key: &str, domain_id: i64, token: &str) -> Box<Future<Item = ::models::ModelsDomain, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/subaccount/domain/{domainId}/verify/email/{token}?{}", configuration.base_path, query_string, domainId=domain_id, token=token);
    ...
    fn domain_router_verify_request(&self, x_sub_account_api_key: &str, domain_id: i64, body: ::models::ModelsVerifyByTokenRequest) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/subaccount/domain/{domainId}/verify/email?{}", configuration.base_path, query_string, domainId=domain_id);
