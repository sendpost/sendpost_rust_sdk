...
pub trait SubaccountemailApi {
    ...
    fn email_router_send_email_with_template(&self, x_sub_account_api_key: &str, body: ::models::ModelsEmailMessage) -> Box<Future<Item = Vec<::models::ModelsEmailResponse>, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>SubaccountemailApi for SubaccountemailApiClient<C> {
    ...
    fn email_router_send_email_with_template(&self, x_sub_account_api_key: &str, body: ::models::ModelsEmailMessage) -> Box<Future<Item = Vec<::models::ModelsEmailResponse>, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/subaccount/email/template?{}", configuration.base_path, query_string);
